            ...
            modelBuilder.Entity("LearnQuestV1.Core.Models.Quiz.UserAnswer", b =>
                {
                    ...
                    b.ToTable("UserAnswers", t =>
                        {
                            t.HasCheckConstraint("CK_UserAnswer_AnswerType", "(SelectedOptionId IS NOT NULL AND BooleanAnswer IS NULL) OR (SelectedOptionId IS NULL AND BooleanAnswer IS NOT NULL)");
                        });
                });
